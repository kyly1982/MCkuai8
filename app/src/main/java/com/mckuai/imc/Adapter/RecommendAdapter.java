...
public class RecommendAdapter extends RecyclerView.Adapter<RecommendAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public RecommendAdapter(Context context, DisplayImageOptions normal, DisplayImageOptions circle,OnItemClickListener listener) {
...
//                        super.onLoadingStarted(imageUri, view);
                        holder.cover.setBackgroundResource(R.mipmap.ic_usercover_default);
                    }
